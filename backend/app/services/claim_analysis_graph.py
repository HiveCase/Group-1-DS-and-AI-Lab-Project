...
class ClaimAnalysisOrchestrator:
    def __init__(self, damage_service: DamageDetectionService | None = None, severity_service: SeverityScoringService | None = None, policy_service: PolicyClauseService | None = None, report_service: ReportSynthesisService | None = None, fraud_service: FraudAgentService | None = None, narrative_service: NarrativeRiskAnalyzerService | None = None):
        ...
        self.narrative_service = narrative_service or NarrativeRiskAnalyzerService()
